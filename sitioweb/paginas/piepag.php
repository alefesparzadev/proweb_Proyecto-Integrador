...
<footer class="text-light position-relative mt-5 pt-5" style="background-color: #1a1a1a;">
  <!-- Olas decorativas -->
  <div class="position-absolute top-0 start-0 w-100" style="transform: translateY(-100%); overflow:hidden; height:80px;">
    <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-100 h-100">
      <path d="M0,0 C300,100 900,0 1200,100 L1200,120 L0,120 Z" fill="rgba(255, 68, 31, 0.1)">
      ...
      <path d="M0,10 C260,90 940,20 1200,95 L1200,120 L0,120 Z" fill="rgba(255, 68, 31, 0.2)">
  ...
  <div class="container">
    <div class="row g-4">
      <div class="col-12 col-md-6 col-lg-3">
        ...
        <div class="d-flex gap-2">
          ...
          <a class="btn btn-outline-primary btn-sm rounded-3" href="#" title="YouTube"><i class="bi bi-youtube"></i></a>
          <a class="btn btn-outline-primary btn-sm rounded-3" href="#" title="X"><i class="bi bi-twitter-x"></i></a>
      ...
      <div class="col-12 col-md-6 col-lg-3">
        <div class="card border-0 shadow-sm" style="background-color: #2a2a2a;">
          <div class="card-body">
            <h6 class="fw-bold mb-2 text-white">Boletín</h6>
            ...
            <form class="needs-validation" novalidate onsubmit="event.preventDefault(); pfNewsletterThanks();">
              <div class="input-group">
                ...
                <input type="email" class="form-control bg-dark border-secondary text-white" placeholder="Correo institucional">
              </div>
              <button class="btn btn-rappi w-100 mt-2 fw-semibold" type="submit">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center pb-4">
      ...
      <div class="d-flex gap-3 small mt-2 mt-md-0">
        <a href="#" class="link-secondary link-opacity-75-hover text-decoration-none">Términos</a>
        <a href="#" class="link-secondary link-opacity-75-hover text-decoration-none">Privacidad</a>
      </div>
    </div>
  </div>

  <!-- Botón volver arriba -->
  <button id="pfTopBtn" class="btn btn-rappi rounded-circle shadow position-fixed" type="button"
          style="right: 20px; bottom: 20px; width: 50px; height: 50px; transform: translateY(120%); transition:.25s ease;">
